		...
		<c:choose>
			...
			<c:otherwise>
				...
				<form method="post" action="add-contact" class="form-inline">
				  ...
				  <div class="row">
				    <div class="col-sm-3"><label for="qref">Reference or Remarks:</label></div>
				    <div class="col-sm-3">
						<input type="qref"
				  ...
				  <div class="row">
				    <div class="col-sm-3"><label for="segments">Contact Person Name:</label></div>
				    <div class="col-sm-3">
						<input type="cpname"
						class="form-control" id="cpname" name="cpname"
						placeholder="cpname">				    
				    </div>
				  </div>

				  <div class="row">
				    <div class="col-sm-3"><label for="pnumber">Phone Number:</label></div>
				    <div class="col-sm-3">
						<input type="pnumber" 
				  ...
				  <div class="row">
				    <div class="col-sm-3"><label for="idesc">Inquiry Description:</label></div>
				    <div class="col-sm-3">
						<input type="idesc"
						class="form-control" id="idesc" name="idesc"
						placeholder="Inquiry Description">				    
				    </div>
				  </div>

				  <div class="row">
				    <div class="col-sm-3"><label for="mailid">Mail Id:</label></div>
				    <div class="col-sm-3">
						<input type="mailid"
